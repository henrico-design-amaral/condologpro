  ...
  return (
    <main className="min-h-screen bg-neutral-950 px-4 py-6 text-white">
      <section className="mx-auto flex max-w-md flex-col gap-5">
        ...
        <Link
          href="/mobile/intake"
          className="flex min-h-24 items-center justify-between rounded-[12px] bg-white px-5 py-5 text-neutral-950 shadow-lg focus:outline-none focus:ring-2 focus:ring-emerald-300 focus:ring-offset-2 focus:ring-offset-neutral-950"
        >
          <span>
        ...
        <section aria-label="Resumo do turno" className="grid grid-cols-3 gap-3">
          <article className="rounded-[12px] border border-neutral-700 bg-neutral-900 p-3 text-center">
        ...
        {overdueCount > 0 ? (
          <Link
            ...
            className="flex min-h-16 items-center justify-between rounded-[12px] border border-rose-400/60 bg-rose-500/10 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-rose-300"
          >
        ...
        <Link
          href="/mobile/pending"
          className="flex min-h-16 items-center justify-between rounded-[12px] border border-neutral-700 bg-neutral-900 px-5 py-4 font-semibold focus:outline-none focus:ring-2 focus:ring-white"
        >
          <span className="flex items-center gap-3">
        ...
        <Link
          href="/admin/history"
          className="flex min-h-14 items-center gap-3 rounded-[12px] border border-neutral-800 px-5 py-4 text-sm font-semibold text-neutral-300 focus:outline-none focus:ring-2 focus:ring-white"
        >
